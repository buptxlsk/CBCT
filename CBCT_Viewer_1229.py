...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # 配置视图窗口和标签在网格中的位置
        self.layout.addWidget(label_axial, 0, 0)
        self.layout.addWidget(self.vtk_widget_axial, 1, 0, 10, 5)
        self.layout.addWidget(label_coronal, 0, 6)
        self.layout.addWidget(self.vtk_widget_coronal, 1, 5, 10, 5)
        self.layout.addWidget(label_sagittal, 11, 0)
        self.layout.addWidget(self.vtk_widget_sagittal, 12, 0, 6, 5)
        self.layout.addWidget(label_3d, 11, 6)
        self.layout.addWidget(self.vtk_widget_3d, 12, 5, 6, 5)

        # 撤销按钮
        
        self.undo_button = QPushButton("Undo", self.central_widget)
        self.undo_button.clicked.connect(self.undo)
        self.layout.addWidget(self.undo_button, 13, 11)
        ...
        # self.layout.addWidget(self.coord_label, 11, 0)
        ...
        self.layout.addWidget(self.projection_back_button, 11, 11)

        self.projection_3d_2d_label = QLabel("3D映射2D：关闭")
        self.layout.addWidget(self.projection_3d_2d_label, 12,11)
    ...
    def create_input_fields(self):
        ...
        # 安排输入字段和标签
        self.layout.addWidget(self.x_input, 11, 1, 1, 1)
        self.layout.addWidget(self.y_input, 0,  7, 1, 1)
        self.layout.addWidget(self.z_input, 0,  1, 1, 1)
        ...
        self.layout.addWidget(QLabel("Brightness"),18,0)
        self.layout.addWidget(self.brightness_slider,18,1)

        self.contrast_slider = QSlider(Qt.Horizontal)
        self.contrast_slider.setRange(1,4000)
        self.contrast_slider.setValue(2000)
        self.contrast_slider.valueChanged.connect(self.update_contrast)
        self.layout.addWidget(QLabel("Contrast"),18,4)
        self.layout.addWidget(self.contrast_slider,18,5)

        
       
        self.layout.addWidget(self.rotate_x_input, 11, 3)
        
        self.layout.addWidget(self.rotate_y_input, 0, 9)
        
        self.layout.addWidget(self.rotate_z_input, 0, 3)
        ...
        self.layout.addWidget(angle_axial, 0, 2)
        self.layout.addWidget(angle_coronal, 0, 8)
        self.layout.addWidget(angle_sagittal, 11, 2)
